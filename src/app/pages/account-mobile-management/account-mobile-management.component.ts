...
@Component({
  selector: 'app-account-mobile-management',
  templateUrl: './account-mobile-management.component.html',
  styleUrls: ['./account-mobile-management.component.scss']
})
export class AccountMobileManagementComponent implements OnInit {
  config = {
    displayKey: 'name',
    search: false,
    height: 'auto',
